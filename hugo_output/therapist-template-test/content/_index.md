...
[[header_blocks]]
  ...
  [[header_blocks.blocks]]
    ...
    items = [{label = "Home", url = "/", type = "link"}, {label = "Services", url = "/services", type = "link"}, {label = "About", url = "/about", type = "link"}, {label = "Contact", url = "#contact", type = "link"}]
